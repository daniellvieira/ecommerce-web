...
// importação do router para que possamos realizar o redirect caso o usuário
// recebe a mensagem da api de que não acesso ao recurso que tentou acessar.
...
// adição da função para setar os headers de authẽnticação na api
// e nos cookies do browser, iremos utilizar ela no interceptor de 
// request (tanto no fluxo normal quando no fluxo de erro).
